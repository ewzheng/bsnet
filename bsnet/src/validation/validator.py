...
class Validator:
    ...
    def evaluate_check_result(self, result: CheckResult) -> bool:
        ...
        metrics = [self._score_snippet(s) for s in scores]
    ...
    def _score_snippet(self, score: EvidenceScore) -> dict:
        """
    ...
    def _aggregate_score(
        ...
        *,
        ...
        # Weak label bias
        score += self._label_bias(label)

        return self._clamp(score, 0.0, 1.0)

    def _label_bias(self, label: str) -> float:
        """
